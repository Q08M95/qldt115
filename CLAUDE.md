...
- **Admin/Quản lý lớp:**
  - Hàng KPI stat card đầu trang (icon outline xám-xanh + nhãn + chevron ở hàng trên; số bên trái, trend pill không nền bên phải — đúng ảnh mẫu, không dùng icon badge nền màu): tổng nhân sự, lớp đang mở, slot còn trống — mỗi stat tile kèm **sparkline nhỏ** phía dưới số (xu hướng hoạt động gần đây), giống style "Sales $94,127 ↑12%" trong ảnh tham khảo. Số cảnh báo pool nhỏ đang mở hiện dưới dạng badge cạnh tiêu đề thẻ "Tỷ lệ lấp đầy slot" (không thêm thẻ stat thứ 4 — StatRow cố định 3 cột)
