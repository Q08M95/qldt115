...
> Chỉnh theo phản hồi test lần 2 (`20260928120000`, test `giai_doan_8e_lien_ket.sql` 5 kiểm tra): thông báo cần duyệt/mời dạy dẫn tới `/dang-ky`, dọn thông báo đã đọc sau 90 ngày, danh sách chia nhóm theo thời gian; `/danh-gia` thay cột Lịch sử giảng dạy bằng 2 thẻ KPI (A/B/C qua các kỳ, từng tiêu chí so với kỳ trước). Chờ chạy migration + test trên Supabase thật.
