...
// Khối nội dung gọn, đặt trong "Cài đặt thông báo" (cai-dat-thong-bao.tsx).
  ...
  return (
    <section className="grid gap-2.5">
      <h3 className="flex items-center gap-2 text-sm font-semibold">
        <Smartphone className="size-4 text-muted-foreground" aria-hidden /> Thông báo đẩy trên thiết bị này
      ...
      {(tt === "chua-bat" || tt === "da-bat") && (
        <div>
          <Button size="sm" variant={tt === "da-bat" ? "outline" : "default"} onClick={doi} disabled={dang}>
