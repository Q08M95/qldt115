...
// Thẻ "Từng tiêu chí so với kỳ trước" — tách riêng để dùng lại được ở Tổng quan (mục 4.7b) ngoài trang /danh-gia.
export function TieuChiSoSanh({ data }: { data: KpiCaNhan | null }) {
